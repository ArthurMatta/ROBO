...
if __name__ == '__main__':
    ...
    rospy.init_node('cat_gym', anonymous=True, log_level=rospy.DEBUG)
    ...
    pkg_path = rospack.get_path('cat_training')
    ...
    Alpha = rospy.get_param("/cat/alpha")
    Epsilon = rospy.get_param("/cat/epsilon")
    Gamma = rospy.get_param("/cat/gamma")
    epsilon_discount = rospy.get_param("/cat/epsilon_discount")
    nepisodes = rospy.get_param("/cat/nepisodes")
    nsteps = rospy.get_param("/cat/nsteps")

    running_step = rospy.get_param("/cat/running_step")
